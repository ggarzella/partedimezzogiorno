    ...
    <div class="row">
        ...
        <div class="col-md-4 col-sm-4 col-xs-4">
            <a href="<?php echo esc_url(get_permalink(get_page_by_path('militare/magistrature/leoni'))); ?>">
                <img class="img-responsive center-block" src="<?=get_template_directory_uri() ?>/images/leoni.jpg"/>
            </a>
        </div>
        <div class="col-md-4 col-sm-4 col-xs-4">
            <a href="<?php echo esc_url(get_permalink(get_page_by_path('militare/magistrature/dragoni'))); ?>">
                <img class="img-responsive center-block" src="<?=get_template_directory_uri() ?>/images/dragoni.jpg"/>
            </a>
        </div>
        <div class="col-md-4 col-sm-4 col-xs-4">
            <a href="<?php echo esc_url(get_permalink(get_page_by_path('militare/magistrature/delfini'))); ?>">
                <img class="img-responsive center-block" src="<?=get_template_directory_uri() ?>/images/delfini.jpg"/>
            </a>
        </div>
    </div>
</div>